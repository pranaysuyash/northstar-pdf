...
- `docs/audits/calibration-corpus-verification-2026-08-28.md` — real-corpus calibration run (13 tests), fingerprint-collision findings, FalsePositiveReport; **§8 V1→V2 migration** — calibration corpus moved to the V2 structured lane (`CorpusEntry.layoutV2`, V2-aware classify/calibrate, 0 V1 references), artifact corrected: navigation 0.900 `knownVariant` (V1 false-similarity) → 0.713 `noMatch` (V2 truth), 6/6 passed, 0 FPs/FNs, accuracy 1.0, suite 1322/1322 (14 tests).
