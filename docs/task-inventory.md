...
| Full unfiltered Swift Testing suite | Unresolved; focused 38-test lane green | P0.2, full-suite release verification | Current-source run with exact failure/hang classification and owner |
